// htmlovermd nav client — builds the folder-tree sidebar from /__manifest__,
...
(function () {
  ...
  function setSidebar(hidden) {
    ...
    try { localStorage.setItem("htmlovermd:sidebar", hidden ? "1" : "0"); } catch (e) {}
    renderToggle();
  }
  var startHidden = false;
  try { startHidden = localStorage.getItem("htmlovermd:sidebar") === "1"; } catch (e) {}
  ...
  var STORE = "htmlovermd:collapsed";
  var collapsed = {};
